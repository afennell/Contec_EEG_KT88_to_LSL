from pybci_lib.Utils.Classifier import Classifier
...
class ClassifierThread(threading.Thread):
    ...
    def __init__(self, closeEvent,trainTestEvent, featureQueueTest,featureQueueTrain, classifierInfoQueue, classifierInfoRetrieveEvent, 
                 ...
                 minRequiredEpochs = 10, clf = None, model = None, torchModel = None, scaler = None):
        super().__init__()
        ...
        self.classifier = Classifier(clf = clf, model = model, torchModel = torchModel, scaler = scaler) # sets classifier class, if clf and model passed, defaults to clf and sklearn

...
class PyBCI:
    ...
    def __init__(self, dataStreams = None, markerStream= None, streamTypes = None, markerTypes = None, loggingLevel = Logger.INFO,
                 ...
                 clf= None, model = None, torchModel = None, scaler = None):
        """
        ...
        self.scaler = scaler
        self.ConfigureMachineLearning(minimumEpochsRequired,  clf, model, torchModel, scaler) # configure first, connect second   
        #self.Connect()
    ...
    def __StartThreads(self):
        ...
        self.classifierThread = ClassifierThread(self.closeEvent,self.trainTestEvent, self.featureQueueTest,self.featureQueueTrain,
                                                ...
                                                clf = self.clf, model = self.model, torchModel = self.torchModel, scaler = self.scaler)
    ...
    def ConfigureMachineLearning(self, minimumEpochsRequired = 10, clf = None, model = None, torchModel = None, scaler = None):
